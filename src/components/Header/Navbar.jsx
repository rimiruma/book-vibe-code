...
const Navbar = () => {
    ...
    const links = <>
    <Link><a href="" className='m-2'>Home</a></Link>
    <Link><a href="" className='m-2'>Listed Books</a></Link>
    <Link><a href="" className='m-2'>Pages To Read</a></Link>
    <Link to="/about"><a href="" className='m-2'>About</a></Link>
    </>
